	...
	events := []models.Event{
		{
			...
			TicketTypes: []models.TicketType{
				{
					Name:           "Presale 1",
					Description:    "Akses terusan selama acara berlangsung",
					Price:          250000,
					Quota:          300,
					RemainingQuota: 0,
				...
				{
					Name:           "Presale 2",
					Description:    "Tiket terusan + Akses Exclusive Lounge",
					Price:          450000,
					Quota:          500,
					RemainingQuota: 124,
		...
		},
		{
			...
			TicketTypes: []models.TicketType{
				{
					Name:           "Presale 1",
					Description:    "Early bird access - Limited promo",
					Price:          150000,
					Quota:          200,
					RemainingQuota: 0,
				...
				{
					Name:           "Presale 2",
					Description:    "Akses standar ke Sat-Set Stage row depan",
					Price:          300000,
					Quota:          300,
					RemainingQuota: 45,
					SalesStartAt:   now.AddDate(0, -1, 0),
		...
		},
		{
			...
			TicketTypes: []models.TicketType{
				{
					Name:           "Presale 1",
					Description:    "First wave access - Rock exclusive",
					Price:          200000,
					Quota:          400,
					RemainingQuota: 0,
					SalesStartAt:   now.AddDate(0, -3, 0),
				...
				{
					Name:           "Presale 2",
					Description:    "Second wave access + Poster signing",
					Price:          400000,
					Quota:          600,
					RemainingQuota: 89,
					SalesStartAt:   now.AddDate(0, -1, 0),
		...
		},
		{
			...
			TicketTypes: []models.TicketType{
				{
					Name:           "Presale 1",
					Description:    "Promo tengah malam - Terhad!",
					Price:          100000,
					Quota:          150,
					RemainingQuota: 0,
					SalesStartAt:   now.AddDate(0, -2, 0),
				...
				{
					Name:           "Presale 2",
					Description:    "Tiket masuk standar + 1 Drink voucher",
					Price:          250000,
					Quota:          350,
					RemainingQuota: 56,
					SalesStartAt:   now.AddDate(0, -1, 0),
		...
		},
		{
			...
			TicketTypes: []models.TicketType{
				{
					Name:           "Presale 1",
					Description:    "Harga khusus warga lokal Madiun",
					Price:          75000,
					Quota:          100,
					RemainingQuota: 0,
					SalesStartAt:   now.AddDate(0, -2, 0),
				...
				{
					Name:           "Presale 2",
					Description:    "Akses standar dengan spot duduk terbaik",
					Price:          150000,
					Quota:          200,
					RemainingQuota: 34,
					SalesStartAt:   now.AddDate(0, -1, 0),
