...
import { Flame, ArrowLeft, MapPin, Calendar, Ticket, Loader2, Sparkles, Clock, ShieldCheck } from 'lucide-react';
                            ...
                            <div className="flex flex-col gap-4">
                              ...
                              <div className="flex flex-col">
                                <span className="text-xs font-bold text-gray-400 line-through decoration-burgundy decoration-2">
                                   {isPresale ? formatPrice(ticket.price * 1.5) : ''}
                                </span>
                              ...
                              <div className="flex items-center justify-between pt-4 border-t-2 border-dashed border-gray-200">
                                <div className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-gray-400">
                                  ...
                                  <span>Tersedia: {ticket.remaining_quota}</span>
                                </div>
                                
                                <button
                                  disabled={!isAvailable}
                                  className={`px-6 py-3 rounded-2xl text-base font-black uppercase tracking-tight border-4 border-black transition-all ${
                                    isAvailable
                                      ? 'bg-salmon text-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-1 hover:translate-y-1'
                                      : 'bg-gray-200 text-gray-400 cursor-not-allowed'
                                  }`}
                                >
                                  {isSoldOut ? 'HABIS' : 'AMBIL'}
                                </button>
                              </div>
                            </div>
                          </div>
